...
public class Game extends Form {
	...
	public Game() {
		...
		try {
			...
			centerContainer.getStyle().setBorder(Border.createLineBorder(3, ColorUtil.rgb(255, 0, 0)));
			...
			this.add(BorderLayout.NORTH, topContainer);// add them to the display
			this.add(BorderLayout.WEST, wesContainer);
